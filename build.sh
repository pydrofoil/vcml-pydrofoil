...
gcc -pthread -shared -Wl,-Bsymbolic-functions ./_pydrofoilcapi_cffi.o -L./pypy-pydrofoil-scripting-experimental/bin -L./pypy-pydrofoil-scripting-experimental/pypy/goal -lpypy3.11-c -o ./_pydrofoilcapi_cffi.so
...
LD_LIBRARY_PATH=.:./pypy-pydrofoil-scripting-experimental/bin ./testplugin ./input/rv64ui-p-addi.elf 10
